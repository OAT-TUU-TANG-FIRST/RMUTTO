...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="Panel1" runat="server" CssClass="divpan" DefaultButton="lbuSearch">
        <div>
            ...
            <div>
                ชื่อตำแหน่งประเภท :&nbsp<asp:TextBox ID="txtSearchStaffName" runat="server" CssClass="ps-textbox" Width="230px" MaxLength="100"></asp:TextBox>
                ...
                <table class="center1">
                    <tr>
                        ...
                        <td style="text-align: left; width: 120px;">
                            <asp:TextBox ID="txtInsertStaffName" runat="server" CssClass="ps-textbox" Width="230px" MaxLength="100"></asp:TextBox></td>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <asp:GridView ID="GridView1" runat="server" Style="margin-left: auto; margin-right: auto; text-align: center;"
                        ...
                        OnPageIndexChanging="myGridViewSTAFF_PageIndexChanging" PageSize="15" CssClass="ps-table-1">
                        <Columns>
                            <asp:TemplateField Visible="false" HeaderText="รหัสตำแหน่งประเภท" ControlStyle-Width="230">
                                <ItemTemplate>
                                    <asp:Label ID="lblStaffIDEdit" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.ST_ID") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="ชื่อตำแหน่งประเภท" ControlStyle-Width="600">
                                <ItemTemplate>
