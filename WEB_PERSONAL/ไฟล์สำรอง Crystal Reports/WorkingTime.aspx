<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="WorkingTime.aspx.cs" Inherits="WEB_PERSONAL.WorkingTime" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="default_page_style">
        <div class="default_header"><img src="Image/Small/table.png" />การลงเวลาปฏิบัติงาน</div>
        <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
            <asp:View ID="View1" runat="server">
                <table class="default_table">
                    ...
                    <tr>
                        ...
                        <td class="col2">
                            <asp:TextBox ID="tbVX1CitizenID" runat="server" CssClass="textbox textbox_default"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td class="col2">
                            <asp:TextBox ID="tbVX1Date" runat="server" CssClass="textbox textbox_default"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td class="col2">
                            ...
                            <div>
                                <div style="margin: 3px 0;">
                                    เข้าเวลา
                                    <asp:TextBox ID="tbVX1HourIn" runat="server" placeHolder="ชั่วโมง" Width="50" CssClass="textbox textbox_default"></asp:TextBox>
                                    
                                    <asp:Label ID="lbVX1HourInVD" runat="server" ForeColor="Red" Text="*" Visible="False"></asp:Label>
                                    
                                    <asp:TextBox ID="tbVX1MinuteIn" runat="server" placeHolder="นาที" Width="51px" CssClass="textbox textbox_default"></asp:TextBox>
                                    <asp:Label ID="lbVX1MinuteInVD" runat="server" ForeColor="Red" Text="*" Visible="False"></asp:Label>
                                </div>
                                <div style="margin: 3px 0;">
                                    เลิกเวลา
                                    <asp:TextBox ID="tbVX1HourOut" runat="server" placeHolder="ชั่วโมง" Width="50" CssClass="textbox textbox_default"></asp:TextBox>
                                    <asp:Label ID="lbVX1HourOutVD" runat="server" ForeColor="Red" Text="*" Visible="False"></asp:Label>
                                    <asp:TextBox ID="tbVX1MinuteOut" runat="server" placeHolder="นาที" Width="50" CssClass="textbox textbox_default"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td class="col2">
                            <asp:TextBox ID="tbVX1Comment" runat="server" CssClass="textbox textbox_default"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="col1"></td>
                        <td class="col2">
                            <asp:LinkButton ID="lbuVX1Next" runat="server" CssClass="button button_default" OnClick="lbuVX1Next_Click">ต่อไป<img src="Image/Small/forward.png" class="icon_right"/></asp:LinkButton>
                        </td>
                    </tr>
                </table>
            </asp:View>
            <asp:View ID="View2" runat="server">
                <table class="default_table">
                    ...
                    <tr>
                        <td class="col1"></td>
                        <td class="col2">
                            <asp:LinkButton ID="lbuVX2Back" runat="server" CssClass="button button_default" OnClick="lbuVX2Back_Click"><img src="Image/Small/back.png" class="icon_left"/>ย้อนกลับ</asp:LinkButton>
                            <asp:LinkButton ID="lbuVX2Finish" runat="server" CssClass="button button_default" OnClick="lbuVX2Finish_Click">ตกลง<img src="Image/Small/add.png" class="icon_right"/></asp:LinkButton>
                        </td>
                    </tr>
                </table>
            ...
            <asp:View ID="View3" runat="server">
                ...
                <asp:LinkButton ID="lbuVX3New" runat="server" OnClick="lbuVX3New_Click" CssClass="button button_default">กลับ</asp:LinkButton>
            </asp:View>
        </asp:MultiView>
