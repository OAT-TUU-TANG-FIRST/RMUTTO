...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="Panel1" runat="server" CssClass="divpan" DefaultButton="lbuSearch">
        <div>
            ...
            <div>
                ชื่อกลุ่มเครื่องราชฯ :&nbsp;<asp:TextBox ID="txtSearchClanInsigName" runat="server" CssClass="ps-textbox" Width="230px" MaxLength="100"></asp:TextBox>
                ...
                <table class="center1">
                    <tr>
                        ...
                        <td style="text-align: left; width: 120px;">
                            <asp:TextBox ID="txtInsertClanInsigName" runat="server" CssClass="ps-textbox" Width="230px" MaxLength="100"></asp:TextBox></td>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <asp:GridView ID="GridView1" runat="server" Style="margin-left: auto; margin-right: auto; text-align: center;"
                        ...
                        OnPageIndexChanging="myGridViewClanInsig_PageIndexChanging" PageSize="15" CssClass="ps-table-1">
                        <Columns>
                            <asp:TemplateField Visible="false" HeaderText="รหัสกลุ่มเครื่องราชฯ" ControlStyle-Width="180">
                                <ItemTemplate>
                                    <asp:Label ID="lblClanInsigIDEdit" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.ID_CLANINSIGNIA") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="ชื่อกลุ่มเครื่องราชฯ" ControlStyle-Width="640">
                                <ItemTemplate>
