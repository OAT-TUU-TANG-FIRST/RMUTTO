...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="Panel1" runat="server" CssClass="divpan" DefaultButton="lbuSearch">
        <div>
            ...
            <div>
                ชื่อประเภทเงินจ้าง :&nbsp;<asp:TextBox ID="txtSearchBudgetName" runat="server" CssClass="ps-textbox" Width="230px" MaxLength="100"></asp:TextBox>
                ...
                <table class="center1">
                    <tr>
                        ...
                        <td style="text-align: left; width: 120px;">
                            <asp:TextBox ID="txtInsertBudgetName" runat="server" CssClass="ps-textbox" Width="230px" MaxLength="100"></asp:TextBox></td>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <asp:GridView ID="GridView1" runat="server" Style="margin-left: auto; margin-right: auto; text-align: center;"
                        ...
                        OnPageIndexChanging="myGridViewBudget_PageIndexChanging" PageSize="15" CssClass="ps-table-1">
                        <Columns>
                            <asp:TemplateField Visible="false" HeaderText="รหัสประเภทเงินจ้าง" ControlStyle-Width="230">
                                <ItemTemplate>
                                    <asp:Label ID="lblBudgetIDEdit" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.BUDGET_ID") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="ชื่อประเภทเงินจ้าง" ControlStyle-Width="600">
                                <ItemTemplate>
