...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="Panel1" runat="server" CssClass="divpan" BackColor="White" ForeColor="#6699FF" BorderColor="Tomato" DefaultButton="btnSearchPositionWork">
        <div>
            <fieldset>
    ...
    <asp:Panel ID="Panel2" runat="server" ScrollBars="Horizontal" CssClass="divpan" BackColor="White" ForeColor="#6699FF" BorderColor="Tomato" DefaultButton="btnSubmitPositionWork">
        <div>
            <fieldset>
                    ...
                    <table class="center1"> 
                        <tr>
                            ...
                            <td style="text-align: left; width: 120px;">
                                <asp:TextBox ID="txtInsertPositionWorkName" runat="server" CssClass="tb5" Width="230px" MaxLength="100"></asp:TextBox></td>
                            <td style="text-align: left;">
                                <asp:Button ID="btnSubmitPositionWork" Text="OK" runat="server" CssClass="master_OAT_button" OnClick="btnSubmitPositionWork_Click" /></td>
                            <td style="text-align: left;">
                                <asp:Button ID="btnCancelPositionWork" Text="Cancel" runat="server" CssClass="master_OAT_button" OnClick="btnCancelPositionWork_Click" /></td>
                        </tr>
                    </table>
                </div>
            </fieldset>
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="GridView1" runat="server" Style="margin-left: auto; margin-right: auto; text-align: center; width: 100%"
                            ...
                            <Columns>
                                <asp:TemplateField Visible="false" HeaderText="รหัสตำแหน่งในสายงาน" ControlStyle-Width="230" HeaderStyle-BackColor="#F7F6F3" HeaderStyle-ForeColor="Tomato">
                                    <ItemTemplate>
                                        <asp:Label ID="lblPositionWorkIDEdit" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.POSITION_WORK_ID ") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="ชื่อตำแหน่งในสายงาน" ControlStyle-Width="600" HeaderStyle-BackColor="#F7F6F3" HeaderStyle-ForeColor="Tomato">
                                    <ItemTemplate>
