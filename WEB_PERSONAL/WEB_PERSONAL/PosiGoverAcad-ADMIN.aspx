<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="PosiGoverAcad-ADMIN.aspx.cs" Inherits="WEB_PERSONAL.PosiGoverAcad_ADMIN" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="Panel1" runat="server" CssClass="divpan" BackColor="White" ForeColor="#6699FF" BorderColor="Tomato" DefaultButton="btnSearchPosiGoverAcad">
        <div>
            <fieldset>
    ...
    <asp:Panel ID="Panel2" runat="server" ScrollBars="Horizontal" CssClass="divpan" BackColor="White" ForeColor="#6699FF" BorderColor="Tomato" DefaultButton="btnSubmitPosiGoverAcad">
        <div>
            <fieldset>
                    ...
                    <table class="center1">
                        <tr>
                            ...
                            <td style="text-align: left;">
                                <asp:Button ID="btnSubmitPosiGoverAcad" Text="OK" runat="server" CssClass="master_OAT_button" OnClick="btnSubmitPosiGoverAcad_Click" /></td>
                            <td style="text-align: left;">
                                <asp:Button ID="btnCancelPosiGoverAcad" Text="Cancel" runat="server" CssClass="master_OAT_button" OnClick="btnCancelPosiGoverAcad_Click" /></td>
                        </tr>
                    </table>
                </div>
            </fieldset>
                        ...
                        <asp:GridView ID="GridView1" runat="server" Style="margin-left: auto; margin-right: auto; text-align: center; width: 100%"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="ชื่อตำแหน่งประเภท" ControlStyle-Width="640" HeaderStyle-BackColor="#F7F6F3" HeaderStyle-ForeColor="Tomato">
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtPosiGoverAcadNameEdit" MaxLength="100" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.P_NAME") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                </asp:TemplateField>
