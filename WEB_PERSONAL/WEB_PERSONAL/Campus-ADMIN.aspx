...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="Panel1" runat="server" CssClass="divpan" BackColor="White" ForeColor="#6699FF" BorderColor="Tomato" DefaultButton="btnSearchCampus">
        <div>
            <fieldset>
    ...
    <asp:Panel ID="Panel2" runat="server" ScrollBars="Horizontal" CssClass="divpan" BackColor="White" ForeColor="#6699FF" BorderColor="Tomato" DefaultButton="btnSubmitCampus">
        <div>
            <fieldset>
                    ...
                    <table class="center1">
                        <tr>
                            ...
                            <td style="text-align: left; width: 120px;">
                                <asp:TextBox ID="txtInsertCampusName" runat="server" CssClass="tb5" Width="230px" MaxLength="100"></asp:TextBox></td>
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="GridView1" runat="server" Style="margin-left: auto; margin-right: auto; text-align: center; width: 100%"
                            ...
                            <Columns>
                                <asp:TemplateField Visible="false" HeaderText="รหัสวิทยาเขต" ControlStyle-Width="180" HeaderStyle-BackColor="#F7F6F3" HeaderStyle-ForeColor="Tomato">
                                    <ItemTemplate>
                                        <asp:Label ID="lblCampusIDEdit" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.Campus_ID") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="ชื่อวิทยาเขต" ControlStyle-Width="640" HeaderStyle-BackColor="#F7F6F3" HeaderStyle-ForeColor="Tomato">
                                    <ItemTemplate>
                                        <asp:Label ID="lblCampusNameEdit" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.Campus_NAME") %>'></asp:Label>
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtCampusNameEdit" MaxLength="100" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.Campus_NAME") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                </asp:TemplateField>
