...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="Panel1" runat="server" CssClass="divpan" DefaultButton="lbuSearch">
        <div>
            ...
            <div>
                ชื่อสถานภาพ :&nbsp<asp:TextBox ID="txtSearchStatusPersonName" runat="server" CssClass="ps-textbox" Width="230px" MaxLength="100"></asp:TextBox>
                ...
                <table class="center1">
                    <tr>
                        ...
                        <td style="text-align: left; width: 230px;">
                            <asp:TextBox ID="txtInsertStatusPersonName" runat="server" CssClass="ps-textbox" MaxLength="100" Width="230px"></asp:TextBox></td>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <asp:GridView ID="GridView1" runat="server" Style="margin-left: auto; margin-right: auto; text-align: center;"
                        ...
                        OnPageIndexChanging="myGridViewStatusPerson_PageIndexChanging" PageSize="15" CssClass="ps-table-1">
                        <Columns>
                            <asp:TemplateField Visible="false" HeaderText="รหัสสถานภาพ" ControlStyle-Width="180">
                                <ItemTemplate>
                                    <asp:Label ID="lblStatusPersonIDEDIT" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.STATUS_ID") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="ชื่อสถานภาพ" ControlStyle-Width="640">
                                <ItemTemplate>
