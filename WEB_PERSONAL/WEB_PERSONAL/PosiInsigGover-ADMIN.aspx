    ...
    <asp:Panel ID="Panel1" runat="server" CssClass="divpan" BackColor="White" ForeColor="#6699FF" BorderColor="Tomato" DefaultButton="btnSearchPosiInsigGover">
        <div>
            <fieldset>
                ...
                <div>
                    ชื่่อระดับตำแหน่งประเภท :&nbsp;<asp:TextBox ID="txtSearchPosiInsigGoverName" runat="server" CssClass="tb5" Width="230px" MaxLength="100"></asp:TextBox>
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="GridView1" runat="server" Style="margin-left: auto; margin-right: auto; text-align: center; width: 100%"
                            ...
                            <Columns>
                                <asp:TemplateField Visible="false" HeaderText="รหัสชื่่อระดับตำแหน่งประเภท" ControlStyle-Width="180" HeaderStyle-BackColor="#F7F6F3" HeaderStyle-ForeColor="Tomato">
                                    <ItemTemplate>
                                        <asp:Label ID="lblPosiInsigGoverIDEdit" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.PIG_ID") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="ชื่่อระดับตำแหน่งประเภท" ControlStyle-Width="640" HeaderStyle-BackColor="#F7F6F3" HeaderStyle-ForeColor="Tomato">
                                    <ItemTemplate>
