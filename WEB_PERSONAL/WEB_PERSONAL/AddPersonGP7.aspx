                    ...
                    <div style="float: left; display: inline-block; margin-right: 50px;">
                        <table>
                            <tr>
                                ...
                                <td class="col2">
                                    <asp:TextBox ID="tbMinistry" runat="server" CssClass="tb5" Enabled="false"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">คำนำหน้านาม</td>
                                <td class="col2">
                                    <asp:TextBox ID="tbTitleName" runat="server" CssClass="tb5" Enabled="false"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">ชื่อ</td>
                                <td class="col2">
                                    <asp:TextBox ID="tbNameTH" runat="server" CssClass="tb5" Enabled="false"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">นามสกุล</td>
                                <td class="col2">
                                    <asp:TextBox ID="tbLastNameTH" runat="server" CssClass="tb5" Enabled="false"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">วัน เดือน ปีเกิด (dd-mm-yyyy)</td>
                                <td class="col2">
                                    <asp:TextBox ID="tbBirthdayDate" runat="server" CssClass="tb5" Enabled="false"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">วัน เดือน ปีเกิด (ตัวบรรจง เต็มบรรทัด)</td>
                                <td class="col2">
                                    <asp:TextBox ID="tbBirthdayLong" runat="server" CssClass="tb5" Enabled="false"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">วันที่บรรจุ (dd-mm-yyyy)</td>
                                <td class="col2">
                                    <asp:TextBox ID="tbInworkDate" runat="server" CssClass="tb5" Enabled="false"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">วันครบเกษียณอายุ (dd-mm-yyyy)</td>
                                <td class="col2">
                                    <asp:TextBox ID="tbRetireDate" runat="server" CssClass="tb5" Enabled="false"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">วันครบเกษียณอายุ (ตัวบรรจง เต็มบรรทัด)</td>
                                <td class="col2">
                                    <asp:TextBox ID="tbRetireLong" runat="server" CssClass="tb5" Enabled="false"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">ประเภทข้าราชการ</td>
                                <td class="col2">
                                    <asp:TextBox ID="tbStaffType" runat="server" CssClass="tb5" Enabled="false"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    </div>
                    <div style="float: left; display: inline-block;">
                        <table>
                            <tr>
                                ...
                                <td class="col2">
                                    <asp:TextBox ID="tbGrom" runat="server" CssClass="tb5" Enabled="false"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
