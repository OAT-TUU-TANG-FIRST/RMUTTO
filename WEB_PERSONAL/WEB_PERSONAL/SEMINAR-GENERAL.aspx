            ...
            <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                <asp:View ID="View1" runat="server">
                    ...
                    <fieldset>
                        ...
                        <asp:Button ID="lblNextV1" Text="ถัดไป" runat="server" CssClass="ps-button" OnClick="lblNextV1_Click" />
                    </fieldset>
                </asp:View>
                        ...
                        <table>
                            <tr>
                                ...
                                <td style="text-align: right; margin-right: 5px;">
                                    <asp:Button ID="btnSaveSeminar" Text="เพิ่มข้อมูลพัฒนาบุคลากร" runat="server" OnClick="btnSubmitSeminar_Click" CssClass="ps-button" /></td>
                            </tr>
                        </table>
                    </fieldset>
                </asp:View>
