        ...
        <asp:Panel ID="Panel6" runat="server">
                ...
                <div>
                    ...
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="TextBox32" runat="server" CssClass="ps-textbox" Enabled="False" Width="269px"></asp:TextBox>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="TextBox33" runat="server" CssClass="ps-textbox" Enabled="False" Width="269px"></asp:TextBox>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            ...
                            <td class="auto-style16">
                                <asp:TextBox ID="TextBox34" runat="server" CssClass="ps-textbox" Enabled="False" Width="269px"></asp:TextBox>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="TextBox35" runat="server" CssClass="ps-textbox" Enabled="False" EnableTheming="True" Width="269px"></asp:TextBox>
                    ...
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td class="auto-style9">
                                <asp:TextBox ID="TextBox36" runat="server" CssClass="ps-textbox" Enabled="False" Width="269px"></asp:TextBox>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            ...
                            <td class="auto-style9">
                                <asp:TextBox ID="TextBox3" runat="server" Enabled="False" Width="269px" CssClass="ps-textbox"></asp:TextBox>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            ...
                            <td class="auto-style9">
                                <asp:TextBox ID="TextBox4" runat="server" Width="269px" Enabled="False" CssClass="ps-textbox"></asp:TextBox>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            ...
                            <td class="auto-style9">
                                <asp:TextBox ID="TextBox5" runat="server" Enabled="False" Width="269px" CssClass="ps-textbox"></asp:TextBox>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            ...
                            <td class="auto-style9">
                                <asp:TextBox ID="TextBox6" runat="server" Enabled="False" Width="269px" CssClass="ps-textbox"></asp:TextBox>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            ...
                            <td class="auto-style9">
                                <asp:TextBox ID="TextBox7" runat="server" Enabled="False" Width="269px" CssClass="ps-textbox"></asp:TextBox>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            ...
                            <td class="auto-style9">
                                <asp:TextBox ID="TextBox8" runat="server" Enabled="False" Width="269px" CssClass="ps-textbox"></asp:TextBox>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            ...
                            <td class="auto-style9">
                                <asp:TextBox ID="TextBox9" runat="server" Enabled="False" Width="269px" CssClass="ps-textbox"></asp:TextBox>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            ...
                            <td class="auto-style9">
                                <asp:TextBox ID="TextBox10" runat="server" Enabled="False" Width="269px" CssClass="ps-textbox"></asp:TextBox>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            ...
                            <td class="auto-style9">
                                <asp:TextBox ID="TextBox11" runat="server" Enabled="False" Width="269px" CssClass="ps-textbox"></asp:TextBox>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            ...
                            <td class="auto-style9">
                                <asp:TextBox ID="TextBox12" runat="server" Enabled="False" Width="269px" CssClass="ps-textbox"></asp:TextBox>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            ...
                            <td class="auto-style9">
                                <asp:TextBox ID="TextBox13" runat="server" Enabled="False" Width="269px" CssClass="ps-textbox"></asp:TextBox>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            ...
                            <td class="auto-style11">
                                <asp:TextBox ID="TextBox14" runat="server" Enabled="False" Width="269px" CssClass="ps-textbox"></asp:TextBox>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="auto-style9">
                                <asp:TextBox ID="TextBox15" runat="server" Enabled="False" Width="269px" CssClass="ps-textbox"></asp:TextBox>
                            </td>
                            <td>
                    ...
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td class="auto-style15">
                                <asp:TextBox ID="TextBox16" runat="server" Enabled="False" Width="63px" CssClass="ps-textbox"></asp:TextBox>
                                <asp:Label ID="Label34" runat="server" Text=")"></asp:Label>
                            </td>
                            <td class="auto-style18">
                                <asp:TextBox ID="TextBox17" runat="server" Enabled="False" Width="159px" CssClass="ps-textbox"></asp:TextBox>
                            </td>
            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <td class="auto-style23">
                        <asp:TextBox ID="TextBox1" runat="server" CssClass="ps-textbox" Enabled="False" Width="269px"></asp:TextBox>
                    </td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                ...
                <tr>
                    ...
                    <td class="auto-style63">
                        <asp:TextBox ID="TextBox2" runat="server" Width="269px" CssClass="ps-textbox" Enabled="False"></asp:TextBox>
                    </td>
                ...
                <tr>
                    ...
                    <td class="auto-style23">
                        <asp:TextBox ID="TextBox18" runat="server" Width="269px" CssClass="ps-textbox" Enabled="False"></asp:TextBox>
                    </td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
            ...
            <div>
                ...
                <tr>
                    ...
                    <td class="auto-style27">
                        <asp:TextBox ID="TextBox21" runat="server" Width="269px" CssClass="ps-textbox" Enabled="False"></asp:TextBox>
                    </td>
                        ...
                        <table style="width: 100%;">
                            <tr>
                                ...
                                <td class="auto-style38">
                                    <asp:TextBox ID="TextBox38" runat="server" CssClass="ps-textbox" Width="269px" Enabled="False"></asp:TextBox>
                                </td>
                                <td class="auto-style40">
                                    <asp:Label ID="Label50" runat="server" Text="เมื่อ วัน/เดือน/ปี"></asp:Label>
                                </td>
                                <td class="auto-style33">
                                    <asp:TextBox ID="TextBox25" runat="server" Width="269px" CssClass="ps-textbox" Enabled="False"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="auto-style39">
                                    <asp:TextBox ID="TextBox39" runat="server" CssClass="ps-textbox" Width="269px" Enabled="False"></asp:TextBox>
                                </td>
                                <td class="auto-style41">
                                    <asp:Label ID="Label55" runat="server" Text="เมื่อ วัน/เดือน/ปี"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="TextBox26" runat="server" Width="269px" CssClass="ps-textbox" Enabled="False"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                        <table style="width: 100%;">
            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <td class="auto-style38">
                        <asp:TextBox ID="TextBox40" runat="server" CssClass="ps-textbox" Width="269px" Enabled="False"></asp:TextBox>
                    </td>
                ...
                <tr>
                    ...
                    <td class="auto-style39">
                        <asp:TextBox ID="TextBox41" runat="server" CssClass="ps-textbox" Width="269px" Enabled="False"></asp:TextBox>
                    </td>
            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <td class="auto-style47">
                        <asp:TextBox ID="TextBox30" runat="server" Enabled="False" Width="269px" CssClass="ps-textbox"></asp:TextBox>
                    </td>
                    <td class="auto-style51">
                        <asp:Label ID="Label58" runat="server" Text="ได้รับเครื่องราชฯ ชั้นล่าสุดวันที่ 5 ธันวาคม"></asp:Label>
                    </td>
                    <td class="auto-style53">
                        <asp:TextBox ID="TextBox31" runat="server" Enabled="False" Width="63px" CssClass="ps-textbox"></asp:TextBox>
                    </td>
                    <td class="auto-style46"></td>
                </tr>
            </table>
            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <td class="auto-style55">
                        <asp:Button ID="Button1" runat="server" CssClass="ps-button" Text="ยกเลิก" Width="110px" />
                    </td>
                    <td class="auto-style56">
                        <asp:Button ID="Button2" runat="server" CssClass="ps-button" OnClick="Button2_Click" Text="แก้ไข" Width="110px" />
                    </td>
                    <td class="auto-style57">
                        <asp:Button ID="Button3" runat="server" CssClass="ps-button" Text="พิมพ์" Width="110px" />
                    </td>
                    <td class="auto-style58">
                        <asp:Button ID="Button4" runat="server" Text="บันทึก" Width="110px" CssClass="ps-button" />
                    </td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
